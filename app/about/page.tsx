          ...
          <div className="max-w-4xl mx-auto relative z-10">
            ...
            <ScrollReveal delay={150}>
              <div className="space-y-6">
                ...
                <p className="text-silver text-base md:text-lg leading-relaxed">
                  The{" "}
                  <span className="font-heading font-semibold">LEA Framework</span> —
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {values.map((value, i) => (
                <ScrollReveal key={value} delay={i * 100}>
                  <div className="border border-white/[0.04] rounded-lg p-10 text-center hover:border-neon/20 transition-colors card-glow">
                    <p className="font-heading text-xl md:text-3xl font-bold tracking-wide">
                      {value}
                    </p>
                  </div>
                </ScrollReveal>
